 ...
 */
package com.tqhy.client.unique;
...
class Server implements Runnable, ConnectionListener {
     ...
     * @param messageHandler The message handler used by this server. It could be null if
    ...
    public int getListenedPort() throws IllegalStateException {
        synchronized (synchLock) {
            ...
            // value.
            if (serverSocket == null) {
                throw new IllegalStateException("JUnique/Server for id \"" + id + "\" not started");
            }
            // Returns the value.
